...
scale = axis;
axis([0.1 0.7 0 12]);
xlabel('1/f(M_{02.5})','FontSize',22,'FontWeight','bold');
ylabel('p_{03}/p_{02.5}','FontSize',22,'FontWeight','bold');
...
cbar = colorbar;
xlabel('N * 1/f(M_{04})','FontSize',22,'FontWeight','bold');
ylabel('p_{04}/p_{04.5}','FontSize',22,'FontWeight','bold');
...
% Plot operating lines on compressor and turbine maps
figure(1)
plot(Op_c_mDot, Op_c_pRatio,'r--','LineWidth',3.0)

figure(2)
plot(Op_t_mDot .* N, Op_t_pRatio,'r--','LineWidth',3.0)