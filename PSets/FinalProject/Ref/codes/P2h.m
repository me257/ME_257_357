...
hold on
colorbar
xlabel('\alpha_b [^o]','FontSize',25,'FontWeight','bold');
ylabel('\beta_c [^o]','FontSize',25,'FontWeight','bold');
axesh = findobj('Type', 'axes');
set(axesh, 'Box','on');
set(gca,'FontSize',23);
plot(60, 45, 'ro','MarkerSize',10.0, 'LineWidth',2.0)
text(61,45,'Turbine Design Point','Color','r','FontSize',15.0,'FontWeight','Bold')
